...
export const experiences = [

    {
        ...
        'points': [
            ...
            'Automated satellite onboard image deletion, handling 10+ operational scenarios, improving onboard storage availability. 🛰️',
            'Designed a Kafka-based notification flow for image capture and processing failure events, improving fault visibility across services. ⛑️',
